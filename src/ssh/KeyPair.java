...
public abstract class KeyPair{
  ...
  public void writeSECSHPublicKey(java.io.OutputStream out, String comment){
    ...
    byte[] pub=proxy.Tools.toBase64(pubblob, 0, pubblob.length);
    try{
      out.write(proxy.Tools.str2byte("---- BEGIN SSH2 PUBLIC KEY ----")); out.write(cr);
      out.write(proxy.Tools.str2byte("Comment: \""+comment+"\"")); out.write(cr);
      int index=0;
	...
	index+=len;
      ...
      out.write(proxy.Tools.str2byte("---- END SSH2 PUBLIC KEY ----")); out.write(cr);
    }
    catch(Exception e){
    }
  }
  ...
  public String getFingerPrint(){
    ...
    return getKeySize()+" "+proxy.Tools.getFingerPrint(hash, kblob);
  }
  ...
  */
  ...
  public static KeyPair load(Configure jsch, String prvkey, String pubkey) throws ProxyException{
	...
	throw new ProxyException("invalid privatekey: "+prvkey);
      ...
      data=proxy.Tools.fromBase64(buf, start, i-start);
	...
	String cipher=proxy.Tools.byte2str(_cipher);

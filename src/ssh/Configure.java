...
//        config.put("mac.c2s", "hmac-md5,hmac-sha1,hmac-sha2-256,hmac-sha1-96,hmac-md5-96");
        ...
        config.put("diffie-hellman-group14-sha1",
                "ssh.DHG14");    // available since JDK8.
        config.put("diffie-hellman-group-exchange-sha256",
                "ssh.DHGEX256"); // available since JDK1.4.2.
        // On JDK8, 2048bits will be used.
        config.put("ecdsa-sha2-nistp256", "jce.SignatureECDSA");
        config.put("ecdsa-sha2-nistp384", "jce.SignatureECDSA");
        config.put("ecdsa-sha2-nistp521", "jce.SignatureECDSA");

        config.put("ecdh-sha2-nistp256", "ssh.DHEC256");
        config.put("ecdh-sha2-nistp384", "ssh.DHEC384");
        config.put("ecdh-sha2-nistp521", "ssh.DHEC521");

        config.put("ecdh-sha2-nistp", "jce.ECDHN");
        ...
        config.put("userauth.none", "ssh.UserAuthNone");
        config.put("userauth.password", "ssh.UserAuthPassword");
        config.put("userauth.keyboard-interactive", "ssh.UserAuthKeyboardInteractive");
        config.put("userauth.publickey", "ssh.UserAuthPublicKey");
        config.put("userauth.gssapi-with-mic", "ssh.UserAuthGSSAPIWithMIC");
        config.put("gssapi-with-mic.krb5", "ssh.jgss.GSSContextKrb5");

        config.put("zlib", "ssh.jcraft.Compression");
        config.put("zlib@openssh.com", "ssh.jcraft.Compression");

        config.put("pbkdf", "jce.PBKDF");

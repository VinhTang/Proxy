...
public interface HostKeyRepository {
     ...
     * Retuns a list for host keys managed in this repository.
     *
     * @param host a hostname used in searching host keys. If <code>null</code>
     * is given, every host key will be listed.
     * @param type a key type used in searching host keys, and it should be
     * "ssh-dss" or "ssh-rsa". If <code>null</code> is given, a key type type
     * will not be ignored.
     */

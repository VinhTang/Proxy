 ...
 *
 * The encryption/decryption method should be compatible with the javascript AES
 * implementation found at: http://www.movable-type.co.uk/scripts/aes.html
 *
 * @author Gerton
 *
 */
public class AESCtr {
    ...
    /**
     * Strong (128 bits) encryption of message using first 16 characters from
     * key.
     *
    ...
    /**
     * Decryption of strong (128bits) encrypted string using first 16 characters
     * from key.
     *
     * @param key The encryption key (use 256bits hash!)
    ...
    /**
     * Unlimited (256 bits) encryption of message using first 32 characters from
     * key.
     * <br/><br/>
     * Due to import-control restrictions imposed by some countries, the
     * jurisdiction policy files shipped with the Java 2 SDK, only permit strong
     * cryptography to be used. An unlimited strength version of these files
     * (that is, with no restrictions on cryptographic strength) is available
     * for download at
    ...
    /**
     * Decryption of unlimited (256bits) encrypted string using first 32
     * characters from key.
     * <br/><br/>
     * Due to import-control restrictions imposed by some countries, the
     * jurisdiction policy files shipped with the Java 2 SDK, only permit strong
